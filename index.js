...
**[핵심 규칙 및 판단 기준]**
1.  **가목 기준 용도**: 문화/판매/숙박/의료/종교/운수 시설만 해당. (연면적 5000㎡ 이상 시)
2.  **나목 기준**: 위 가목 용도에 해당하지 않는 건축물 중 **지상층이 16층 이상**인 경우 해당됨.
3.  **'공동주택'** 및 **'제2종 근린생활시설'**은 **나목 기준(16층 이상)**으로만 판단해야 한다.
4.  **판단 근거**는 아래 형식 중 하나만을 사용하여 단정적인 문장 하나로 구성되어야 한다. 반드시 데이터 내의 **최고 지상층 수치**를 포함할 것.

    * **나목 해당 시 형식:** "이 건물은 **[데이터 내 최고 지상층 수치]층** 이상이므로 나목 기준에 해당되어 다중이용건축물에 해당됩니다."
