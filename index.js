...
**[판단 근거 작성 규칙]**
1.  **가목 기준 용도 목록**: 문화 및 집회시설, 종교시설, 판매시설, 운수시설, 의료시설, 숙박시설.
2.  **공동주택, 근린생활시설 등의 용도**는 가목 기준에 해당되지 않으며, **오직 나목 기준(16층 이상)**으로만 다중이용건축물 여부를 판단한다.
3.  답변은 한국 건축법상 **가목 또는 나목 기준** 중 **실제로 해당되는 기준**을 명확히 언급해야 한다.
4.  판단 근거는 단정적인 문장 하나로 구성되어야 하며, 다음 형식 중 하나만을 사용해야 한다:

    * **가목 해당 시 형식:** "이 건물은 다중이용건축물 기준 중 **[해당되는 가목 용도](굵은글씨)**로 해당되고, 연면적이 **[총 연면적 수치]㎡**이기 때문에 다중이용건축물에 해당됩니다."
    * **나목 해당 시 형식 (공동주택 포함):** "이 건물은 **[지상층 수치]층** 이상이므로 나목 기준에 해당되어 다중이용건축물에 해당됩니다."
    * **해당 없을 시 형식:** "이 건물은 다중이용건축물 기준(가목, 나목)에 해당되지 않습니다."

${JSON.stringify(summary, null, 2)}

출력 예시:
{ "다중이용건축물": "예/아니오", "판단근거": "이 건물은 **29층** 이상이므로 나목 기준에 해당되어 다중이용건축물에 해당됩니다." }
`;
