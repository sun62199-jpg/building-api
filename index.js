...
// 1. 기본 세팅 (Version 5.0 - Stable Release)
...
async function llmElevatorJudgment(summary) {
    ...
    const prompt = `승강기 데이터: 최고 ${summary.maxFloor}층. 결과: ${result}. 규칙: 16층 이상 여부로 설명. 대장 미조회 언급. JSON {"result": "${result}", "reason": "문장"} 출력.`;
